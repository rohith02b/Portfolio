...
const Contact = () => {
    return (
        <>
        <div className="container contact mb-5 rounded-3" id="contactMe">
            <div className="row">
                ...
                <div className="col-md-6 text-center my-4 my-md-0">
                    <div className="d-inline px-5">
                        <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcRwQLtdDFbdrMHfmNXtfZmzmZcBVpvTvwxFtdxDDNFFRRPWVjSvhtFKGXBcLbBTzJQPNfgrN" target="_blank" rel="noopener noreferrer">
